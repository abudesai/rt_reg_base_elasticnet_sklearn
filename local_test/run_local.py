...
def copy_example_files():     
    # data schema
    shutil.copyfile("./examples/abalone_schema.json", os.path.join(data_schema_path, "abalone_schema.json"))
    # train data    
    shutil.copyfile("./examples/abalone_train.csv", os.path.join(train_data_path, "abalone_train.csv"))    
    # test data     
    shutil.copyfile("./examples/abalone_test.csv", os.path.join(test_data_path, "abalone_test.csv"))    
    # hyperparameters
